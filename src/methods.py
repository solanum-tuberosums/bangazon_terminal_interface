...
def build_db():
        '''Inserts James Blake Songs and info into db and prints the results'''
        with sqlite3.connect('db.sqlite3') as conn:
            c = conn.cursor()
            try:
        ...
        FOREIGN KEY (customer_id)       REFERENCES Customer(id) ON DELETE CASCADE)""")
                c.execute("""CREATE TABLE ProductType(
        id                               INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
        label                            VARCHAR(20))""")
        ...
        FOREIGN KEY (customer_id)       REFERENCES Customer(id) ON DELETE CASCADE)""")
                c.execute("""CREATE TABLE CustomerOrder(
        id                              INTEGER NOT NULL PRIMARY KEY AUTOINCREMENT,
        ...
        Values(NULL, 'Jeremy', 'Will', 'Smith', '500 Interstate Blvd S.', 'Nashville', 'TN', '37201', '615-888-5555', '05-09-2017')
        """)
                c.execute("""INSERT INTO Customer 
        Values(NULL, 'Blaise', 'Zak', 'Williams', '500 Interstate Blvd S.', 'Nashville', 'TN', '37201', '615-888-5555', '05-09-2017')
        """)
                c.execute("""INSERT INTO Customer 
        Values(NULL, 'Jessica', 'Z.', 'Michaels', '500 Interstate Blvd S.', 'Nashville', 'TN', '37201', '615-888-5555', '05-09-2017')
        """)
                c.execute("""INSERT INTO ProductType 
        ...
        VALUES (NULL, 19.99, "Red Ball", "Bouncy", 1, 1)
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 29.99, "Ford Truck", "F-150", 1, 2);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 9.99, "AA Batteries", "Fully-Charged", 1, 3);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 5.99, "Green Ball", "Squishy", 1, 1);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 2.99, "White Out", "Fix Mistakes", 1, 2);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 999.99, "Diamonds", "Girl's Best Friend", 1, 3);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 39.99, "USB Drive", "1TB", 1, 1);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 7.99, "Blocks", "Hard", 2, 1);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 15.99, "Water Bottle", "Aluminum", 2, 2);
        """)
                c.execute("""INSERT INTO Product
        VALUES (NULL, 32.99, "Power Strip", "Surge Protector", 2, 3);
        """)
                conn.commit()
